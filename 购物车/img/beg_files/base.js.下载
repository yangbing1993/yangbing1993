            ...
            success: function (result) {
                if (result.DoFlag) {
                    $.each(result.QueryIndexCategorysDtos, function (i, item) {
                        ...
                        $(".ui-category dl dt a").unbind().bind("click", function () {
                            var _this = $(this);
    ...
    var timer = setInterval(function () {
        ...
        if (window.UserGuid != null) {
            ...
            if (window.location.href.indexOf(".aspx") > 0) {
                ...
                if (window.location.href.indexOf("haitao.muyingzhijia.com") > 0 || window.location.href.indexOf("t.muyingzhijia.com") > 0) {
                    root = "http://static.boodoll.cn/mall/v16/";
                } else if (window.location.href.indexOf("haitao.beta.muyingzhijia.com") > 0 || window.location.href.indexOf("t.beta.muyingzhijia.com") > 0) {
                    root = "http://static.beta.muyingzhijia.com/mall/v16/";
                } else if (window.location.href.indexOf("haitao.muyingzhijia.me") > 0) {
                    root = "http://static.muyingzhijia.me/mall/";
                } else if (window.location.href.indexOf("haitao.r.muyingzhijia.com") > 0 || window.location.href.indexOf("t.r.muyingzhijia.com") > 0) {
                    root = "http://o.static.boodoll.cn/mall/yfb/";
                } else {
                    root = window.ThemesRoot
                }
            }
            myzjStat.src = root + "js/myzjStatic.js?v=" + (Date.parse(new Date())) / 1000;
