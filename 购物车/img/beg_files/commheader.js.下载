...
$(function () {
    ...
    //    var adContainer = [
    //        {
    //        "parentNode": ".right-wrap .banner ul li",//个人中心头图
    //        "position": "absolute",
    //        "bottom": "10px",
    //        "right": "10px",
    //        "left": "",
    ...
    //        html.push('<img style="width:auto; height:auto;z-index:2;position:'+ list.position +'; bottom:' + list.bottom + '; left:' + list.left + ';right:' + list.right + ';top:' + list.top + '" src="' + imgUrl + '">');
...
var HeaderEvent = {
    ...
    ClickBtn: function () {
        ...
        //统计
        myzjStorage({ name: "passway2", value: decodeURIComponent(searstr.replace(/^\s+|\s+$/g, "")) });
        myzjStorage({ name: "passway3", value: "" });
        myzjStorage({ name: "passway4", value: "" });
        myzjStorage({ name: "passway5", value: "" });
        myzjStatistics({
